...
def add_show(request):
    show = Show.objects.create(title=request.POST["show_add_title"], network=request.POST["show_add_network"],
                            releaseDate=request.POST["show_add_date"], description=request.POST["show_add_description"])
...
def update_show(request, id):
    show_id = int(id)
    show = Show.objects.get(id=show_id)
    show.title = request.POST["show_update_title"]
    show.network = request.POST["show_update_network"]
    show.releaseDate = request.POST["show_update_date"]
    show.description = request.POST["show_update_description"]
    show.save()
